...
**📈 个股与板块分析**
- **个股分析** Stock Analysis (Beta) — 唯一多周期 K 线、20 主图/38 副图、11 类价位、缠论/形态/画线与 AI 四维分析
- **财务分析** Financials — 利润表/资负表/现金流/关键指标(本地全市场历史 + 多源并集合并 + fuyao 财务四表适配) + AI 解读
...
| 6      | 个股分析(统一多周期 K 线 + 全指标/价位/缠论/形态 + AI 四维分析)     | ✅    |
