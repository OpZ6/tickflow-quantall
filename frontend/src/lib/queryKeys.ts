...
export const QK = {
  ...
  dataFoundation: ['data-foundation'] as const,
  ...
  marketLabMembers: (dimension: string, sector: string, asOf?: string) => ['market-lab', 'sector-members', dimension, sector, asOf ?? 'latest'] as const,
